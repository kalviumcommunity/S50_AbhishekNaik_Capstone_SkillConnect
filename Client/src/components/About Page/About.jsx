...
const AboutPage = () => {
  return (
    <motion.div
      className="container mx-auto py-6 px-4 sm:px-6 lg:px-8 bg-black text-white"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      >
        <Card className="bg-gray-300 rounded-lg p-6 shadow-md flex flex-col items-center">
          <CardHeader>
